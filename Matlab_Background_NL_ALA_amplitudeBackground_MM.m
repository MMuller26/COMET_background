%% NL BGS after different times after ALA application MM
clear all
close all
clc
...
ylabel('amplitude')
xlim([0 7])
title('amplitude of background signal over time 630nm MM')
...
ylabel('amplitude')
xlim([0 7])
title('Amplitude of background signal over time 670nm MM')
...
ylabel('amplitude')
xlabel('time passed(hours)')
title('Amplitude of background signal over time MM')